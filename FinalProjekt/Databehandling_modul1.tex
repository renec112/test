...
På figur \cref{fig:graf1} ses $\theta_{sep}$ plottet som funktion af $f_s$. Usikkerhederne på denne graf er bestemt ved ophobningsloven idet at usikkerhederne på $l$ og $d$ er kendte.
